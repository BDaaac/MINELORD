...
export const SAPPER_NICKNAMES = [
  "ГРАНИТ", "КАЛИБР", "БРИТВА", "ТАЙПАН",
  "ТУМАН",  "ТРОТИЛ", "ЖНЕЦ",   "КЛЕЩ",
  "СФЕНКС", "ЗАПАЛ",  "ФИТИЛЬ", "КИНЖАЛ",
  "СКАТ",   "УДАР",   "ЗЕНИТ",  "КРАТЕР",
  "КОРШУН", "МАРКЕР", "ПЕПЕЛ",  "САМУМ",
  "КРОТ",   "КАПКАН", "ВИХРЬ",  "ШНУР",
] as const;

export const BOSS_NICKNAMES: Partial<Record<AiType, string>> = {
  "The Colonel": "ПОЛКОВНИК",
  "The Ghost":   "ПРИЗРАК",
  "The Machine": "ОРАКУЛ",
};

export const MOVE_PHRASES = {
  spawn: [
    "прорыв обнаружен на [{cell}]",
    "вхожу через [{cell}]",
    "периметр нарушен на [{cell}]",
    "начинаю зачистку с [{cell}]",
    "точка входа: [{cell}]",
  ],
  safe: [
    "[{cell}] — чисто",
    "сектор [{cell}] пройден",
    "[{cell}] — нет угрозы",
    "чисто на [{cell}]. двигаюсь дальше",
    "[{cell}] — зона свободна",
  ],
  number: [
    "[{cell}]: {n} угроз поблизости",
    "сигнал {n} на [{cell}] — пересчитываю маршрут",
    "открываю [{cell}]... значение = {n}",
    "[{cell}] — опасный сектор. значение {n}",
    "зафиксировано {n} на [{cell}]. обновляю карту",
  ],
  explosion: [
    "💥 ДЕТОНАЦИЯ НА [{cell}] — УНИЧТОЖЕН",
    "💥 МИНА НА [{cell}] — КОНЕЦ СВЯЗИ",
    "💥 ПОДРЫВ НА [{cell}] — ПОТЕРЯ БОЙЦА",
    "💥 [{cell}] — ПОСЛЕДНЯЯ ОШИБКА",
    "💥 ВЗРЫВ НА [{cell}] — МИССИЯ ПРОВАЛЕНА",
  ],
  defuse: [
    "ЦЕЛЬ ЗАХВАЧЕНА [{cell}] — ВЫ ПРОИГРАЛИ",
    "ДЕФЬЮЗ ПОИНТ [{cell}] ДОСТИГНУТ. MISSION FAILED.",
    "НАШЁЛ ЕГО — ДЕФЬЮЗ [{cell}]. КОНЕЦ.",
  ],
  think: {
    Rookie: [
      "иду наугад...",
      "данных нет — рискую",
      "просто выбираю клетку...",
      "а, была не была...",
    ],
    "Rookie+": [
      "есть подозрительные зоны...",
      "пробую осторожно...",
      "стараюсь не рисковать зря...",
    ],
    Analyst: [
      "строю карту вероятностей...",
      "пересчитываю безопасные маршруты...",
      "нахожу оптимальный путь...",
      "вычисляю минимальный риск...",
    ],
    Gambler: [
      "чувствую удачу...",
      "сегодня мне везёт",
      "интуиция важнее статистики",
      "а вдруг пронесёт?",
    ],
    Hunter: [
      "чую мины — иду на запах",
      "двигаюсь к центру поля",
      "высокая плотность угроз — интересно",
    ],
    "The Colonel": [
      "сканирую периметр... всё под контролем",
      "угловой сектор чист — продвигаюсь по плану",
      "вероятность превышена — избегаю",
      "ни одной ошибки за 30 лет",
      "ваша расстановка любительская",
      "слишком предсказуемо",
      "активирую СКАН...",
    ],
    "The Ghost": [
      "сканирую память предыдущих миссий...",
      "в прошлый раз вы ставили мины в углах",
      "новый паттерн. адаптируюсь",
      "я не забываю ни одного хода",
      "вы меняете тактику — но я учусь быстрее",
    ],
    "The Machine": [
      "анализирую конфигурацию поля...",
      "обновляю байесовскую модель...",
      "оптимальный маршрут рассчитан",
      "вы не можете обмануть алгоритм",
      "ваша стратегия классифицирована как AMATEUR",
      "confidence: высокий — принимаю решение",
    ],
